export default function TermsOfService() {
  return (
    <section>
      <p className="text-2xl py-8">Privacy Policy</p>
      <div className="space-y-4 text-lg">
        <p>
          Your privacy is important to us. It is Fireforms&#39; policy to
          ...
          across our website,{" "}
          <a href="https://fireforms.io">https://fireforms.io</a>, and other
          sites we own and operate.{" "}
        </p>
        <p>
          This policy is effective as of 19 November 2021 and was last updated
          on 19 November 2021.{" "}
        </p>
        ...
        <h4 className="text-xl font-bold">Log Data</h4>
        <p>
        ...
        <h3 className="text-xl font-bold">GDPR rights for respondents</h3>
        <p>
          If you’ve answered a form built with fireforms, who is responsible for
          looking after that data? As our Privacy Policy states, if you’ve
          submitted your personal data through a form, the creator of that form
          is responsible for this data. Fireforms only processes this data on
          the creator’s behalf. This means that if you want to exercise any of
          your GDPR rights, you should contact the person or organization that
          created the form. If this isn’t possible, we’ll do our best to put you
          in touch with the creator of the form.
        </p>
        ...
        <h3 className="text-xl font-bold">Limits of Our Policy</h3>
        <p>
        ...
        <p>
          EXCEPT AS OTHERWISE SET FORTH ON THIS SITE, INCLUDING WITHOUT
          LIMITATION THE PRODUCT DESCRIPTIONS OF SPECIFIC PRODUCTS, THIS SITE,
          THE PRODUCTS OFFERED FOR SALE ON IT AND THE TRANSACTIONS CONDUCTED
          THROUGH IT ARE PROVIDED BY US ON AN "AS IS" BASIS. WE MAKE NO
          ...
          AND FITNESS FOR A PARTICULAR PURPOSE, NONINFRINGEMENT, TITLE, QUIET
          ENJOYMENT, DATA ACCURACY AND SYSTEM INTEGRATION. THIS SITE MAY INCLUDE
          INACCURACIES, MISTAKES OR TYPOGRAPHICAL ERRORS. WE DO NOT WARRANT THAT
          THE CONTENT WILL BE UNINTERRUPTED OR ERROR FREE. TO THE MAXIMUM EXTENT
          PERMITTED BY LAW, WE WILL NOT BE LIABLE FOR ANY DAMAGES OF ANY KIND
          ...
          DAMAGES. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, OUR TOTAL
          ...
          PAID BY YOU TO US DURING THE MONTH IMMEDIATELY PRECEDING THE ACT
